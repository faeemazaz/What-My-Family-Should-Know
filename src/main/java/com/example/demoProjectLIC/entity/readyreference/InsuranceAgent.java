...
public class InsuranceAgent extends ReadyReferenceField {

    @ManyToOne(cascade = CascadeType.ALL)
    @JoinColumn(name = "userId")
    private HeadOfFamily headOfFamily;

    public InsuranceAgent(Long id, String name, String officeAddress, String residenceAddress, String contact, HeadOfFamily headOfFamily) {
